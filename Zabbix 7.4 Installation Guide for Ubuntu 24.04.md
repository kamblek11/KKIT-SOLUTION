...
zcat /usr/share/zabbix/sql-scripts/mysql/server.sql.gz | mysql --default-character-set=utf8mb4 -u inzabbix -p inzabbix
Disable trust flag:
...
9. (Optional) Install Zabbix Agent on Additional Client Machines
